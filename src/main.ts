    ...
    callback({
      responseHeaders: {
        ...
        'Content-Security-Policy': [
          "default-src 'self' 'unsafe-eval'; connect-src 'self' https://launchermeta.mojang.com; img-src 'self' https:; script-src 'self' 'unsafe-eval'; style-src 'self' 'unsafe-inline';",
        ],
      },
    })
  })
